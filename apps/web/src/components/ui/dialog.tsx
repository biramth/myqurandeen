...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // max-h + overflow-y-auto : sans ca, un formulaire plus haut que
        // l'ecran (frequent sur mobile en paysage ou avec un clavier
        // virtuel ouvert) depasse des deux cotes du viewport sans aucun
        // moyen d'atteindre son pied de page (boutons Enregistrer/Annuler).
