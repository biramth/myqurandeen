...
const SCHOLARS: ScholarSeed[] = [
  ...
  },
  {
    ...
    bio: "Compilateur de Jami at-Tirmidhi, l'un des quatre Sunan, élève d'Al-Bukhari dont il poursuit et complete la méthode. Il se distingue par son habitude d'indiquer systematiquement, après chaque hadith, son degré d'authenticité (sahih, hasan ou da'if) ainsi que les positions juridiques divergentes des différentes écoles qui s'appuient sur ce texte, faisant de son recueil un outil précieux pour l'étude comparee du fiqh. Devenu aveugle vers la fin de sa vie, il continua a enseigner et a transmettre son savoir jusqu'a sa mort a Tirmidh.",
    expertise: ["Sciences du hadith"],
  },
  {
    name: "An-Nasa'i",
  ...
  },
  {
    ...
    diedYear: 887,
    place: "Qazvin, Perse",
    bio: "Compilateur de Sunan Ibn Majah, sixième recueil retenu dans les Kutub as-Sittah (les six livres canoniques de hadiths sunnites), aux cotes des deux Sahih et des trois autres Sunan. Son recueil, organise par chapitres de fiqh comme les autres Sunan, contient un nombre notable de hadiths dits \"zawa'id\" (additionnels) ne figurant dans aucun des cinq autres recueils canoniques, ce qui explique son inclusion tardive mais reconnue dans le canon des six livres malgré des critères de selection generalement juges moins stricts que ceux de ses predecesseurs.",
    expertise: ["Sciences du hadith"],
  },
  {
    name: "At-Tabari",
    ...
    bio: "Historien, exegete et juriste d'une exceptionnelle productivite, At-Tabari s'installa a Bagdad ou il consacra sa vie a l'étude et a l'enseignement, refusant les postes officiels qui lui étaient proposes pour preserver son independance intellectuelle. Il est l'auteur de deux ouvrages monumentaux restes des references incontournables : Tarikh al-Rusul wal-Muluk (\"Histoire des prophètes et des rois\"), chronique universelle depuis la Creation jusqu'a son époque organisee annee par annee et fondee sur la compilation critique de multiples récits avec leurs chaînes de transmission, et Jami al-Bayan 'an Ta'wil Ayi al-Qur'an, l'un des plus anciens et des plus vastes tafsirs complets du Coran, qui rassemble systematiquement les interprétations des generations precedentes plutôt que d'imposer une lecture unique. Il developpa également sa propre école juridique minoritaire (jaririte), qui ne survecut pas au-dela de quelques generations.",
  ...
  },
  {
    ...
    diedYear: 1111,
    place: "Tus, Perse",
    bio: "Théologien, juriste et penseur majeur, Abu Hamid al-Ghazali enseigna a la prestigieuse madrasa Nizamiyya de Bagdad avant de traverser, selon son propre récit autobiographique (Al-Munqidh min ad-Dalal, \"Ce qui delivre de l'erreur\"), une crise spirituelle profonde qui le poussa a abandonner sa position et a se consacrer pendant plusieurs années a une vie ascetique et contemplative. Il est l'auteur d'Ihya Ulum ad-Din (\"Revivification des sciences de la religion\"), œuvre monumentale de synthese entre droit, théologie et spiritualité soufie, structuree en quatre parties couvrant les actes d'adoration, les usages sociaux, les vices a eviter et les vertus a cultiver. Il a également marqué durablement la théologie ash'arite et le rapport entre philosophie grecque et pensée islamique, notamment par son ouvrage Tahafut al-Falasifa (\"L'incoherence des philosophes\"), critique systematique de certaines positions des philosophes rationalistes musulmans comme Ibn Sina, qui suscitera plus tard une réponse celebre d'Ibn Rushd.",
  ...
  },
  {
    ...
    bio: "Juriste malikite, medecin et philosophe de Cordoue, connu en Occident latin sous le nom d'Averroes, ou il exerca une influence majeure sur la scolastique medievale europeenne a travers ses commentaires d'Aristote. Il occupa la fonction de qadi (juge) a Séville puis a Cordoue et rediga un ouvrage de fiqh compare, Bidayat al-Mujtahid, encore etudie aujourd'hui pour sa méthode d'analyse des divergences entre écoles juridiques. Il est surtout celebre pour Tahafut at-Tahafut (\"L'incoherence de l'incoherence\"), reponse detaillee a la critique qu'Al-Ghazali avait adressee aux philosophes, dans laquelle il defend la compatibilite entre raison philosophique et revelation. Ses dernieres annees furent marquees par une disgrace temporaire aupres du pouvoir almohade, ses ecrits philosophiques etant juges suspects par certains cercles religieux de son époque.",
  ...
  },
  {
    ...
    diedYear: 1209,
    place: "Ray, Perse",
    bio: "Théologien ash'arite et exegete shafi'ite, Fakhr ad-Din ar-Razi est l'auteur d'un immense tafsir, Mafatih al-Ghayb (\"Les clefs de l'invisible\"), qui integre systematiquement des discussions de théologie, de philosophie, de logique et de sciences naturelles de son époque a l'explication des versets, en fait l'un des tafsirs les plus intellectuellement exigeants de la tradition sunnite. Egalement forme aux sciences rationnelles (kalam, logique, medecine), il chercha tout au long de son œuvre a articuler rigueur rationnelle et fidelite aux textes revelees, dans la continuite de la démarche ash'arite d'Al-Ghazali. Il voyagea et enseigna dans plusieurs regions d'Asie centrale et de Perse avant de s'installer a Herat, ou il mourut.",
  ...
  },
  {
    ...
    diedYear: 1350,
    place: "Damas, Syrie",
    bio: "Savant hanbalite, principal élève et compagnon d'Ibn Taymiyyah, qu'il accompagna jusque dans ses emprisonnements et dont il transmit et developpa l'enseignement après sa mort dans une œuvre ecrite abondante et souvent d'une grande finesse litteraire. Auteur notamment de Zad al-Ma'ad (guide de conduite fondé sur l'exemple prophétique), de Madarij as-Salikin (traite de spiritualité et de cheminement de l'âme) et d'écrits sur la medecine prophetique (At-Tibb an-Nabawi), il aborde une large diversite de sujets - droit, spiritualité, psychologie religieuse, polemique theologique - avec un style considere comme particulièrement accessible malgre la profondeur du contenu.",
  ...
  },
  {
    ...
    diedYear: 833,
    place: "Égypte",
    bio: "Editeur et transmetteur de la biographie du Prophète ﷺ (As-Sira an-Nabawiyya), a partir de la version plus ancienne et plus volumineuse d'Ibn Ishaq (m. 767), aujourd'hui perdue dans sa forme originelle et connue principalement a travers cette édition. Ibn Hisham revisa le texte d'Ibn Ishaq en retirant certains éléments qu'il jugeait peu fiables ou hors sujet (notamment de la poesie preislamique) et en ajoutant ses propres annotations philologiques et geographiques, produisant une version plus concise et mieux structuree. Son ouvrage demeure, avec les chroniques d'At-Tabari, l'une des sources sira les plus anciennes et les plus citees dans l'étude de la vie du Prophète ﷺ.",
