    ...
    lessons: [
      {
        ...
        keyTakeaways: [
          "Le tafsir bi'l-ma'thur s'appuie sur la transmission (Coran, Sunna, propos des premières generations).",
