...
const PERIODS: PeriodSeed[] = [
    ...
    events: [
      {
        ...
        dateApprox: "632",
        eventType: "event",
        description: "Abu Bakr as-Siddiq est désigne premier calife après le décès du Prophète ﷺ.",
        source: TARIKH_TABARI,
      },
      {
        ...
        dateApprox: "632-633",
        eventType: "battle",
        description: "Campagnes menees par Abu Bakr pour retablir l'autorité de Médine sur des tribus arabes ayant fait secession après la mort du Prophète ﷺ.",
        source: TARIKH_TABARI,
      },
      {
        ...
        dateApprox: "636",
        eventType: "battle",
        description: "Victoire decisive des armees musulmanes sur l'Empire byzantin au Levant, ouvrant la voie à la conquête de la région.",
        source: TARIKH_TABARI,
      },
      {
    ...
    events: [
      {
        ...
        dateApprox: "762",
        eventType: "event",
        description: "Le calife abbasside Al-Mansur fondé Bagdad, qui devient la capitale du califat.",
        source: BIDAYA_IBN_KATHIR,
      },
      {
  ...
  },
  {
    ...
    description: "Présence musulmane dans la péninsule ibérique, de la conquête de 711 à la chute de Grenade en 1492.",
    events: [
      {
      ...
      },
      {
        ...
        dateApprox: "1492",
        eventType: "event",
        description: "Prise de Grenade, dernier bastion musulman de la péninsule ibérique, par les Rois Catholiques, mettant fin à la présence politique musulmane en Espagne.",
        source: BIDAYA_IBN_KATHIR,
      },
    ],
  },
