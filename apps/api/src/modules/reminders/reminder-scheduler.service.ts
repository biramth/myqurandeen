...
// Les helpers purs (localClock, minutesSince, alreadySentToday, GRACE_MINUTES)
// et le type LocalClock sont extraits dans ./scheduling-logic.ts (testables
// sans tirer NestJS). Re-exportes ici pour compatibilite avec les services qui
// les importaient depuis ce module.
export { alreadySentToday, GRACE_MINUTES, localClock, minutesSince } from "./scheduling-logic";
export type { LocalClock } from "./scheduling-logic";
